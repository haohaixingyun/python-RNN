...
import sys
import importlib   # by ethan
importlib.reload(sys) # by ethan
#reload(sys)
#sys.setdefaultencoding('utf8')
PYTHONIOENCODING="UTF-8"    # by ethan
import collections
...
# 从文件中读取唐诗
with open(ORIGIN_DATA, 'rb') as f:    # rb by ethan
    print('I am reading the peotry')  # by ethan
    f_lines = f.readlines()
